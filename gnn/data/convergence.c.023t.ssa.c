...
gsl_min_test_interval (double x_lower, double x_upper, double epsabs, double epsrel)
{
  ...
  __BB(3):
  gsl_error ("relative tolerance is negative", ".//convergence.c", 37, 13);
  _28 = 13;
  ...
  __BB(5):
  gsl_error ("absolute tolerance is negative", ".//convergence.c", 40, 13);
  _26 = 13;
  // predicted unlikely by early return (on trees) predictor.
  goto __BB17;
  ...
  __BB(7):
  gsl_error ("lower bound larger than upper_bound", ".//convergence.c", 43, 4);
  _24 = 4;
  // predicted unlikely by early return (on trees) predictor.
  goto __BB17;
